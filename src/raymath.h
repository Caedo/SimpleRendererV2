...
// ====================================== //
// == Funtions added by Paweł Dziedzic == //
// ====================================== //
...
RMDEF Vector2 operator*(Vector2 a, float s)
{
	return {a.x * s, a.y * s};
}
...
RMDEF Vector3 operator+(Vector3 a, Vector3 b)
{
...
RMDEF Vector3 operator*(Vector3 a, float s)
{
...
RMDEF Matrix operator*(Matrix a, Matrix b)
{
    Matrix ret = {0};
